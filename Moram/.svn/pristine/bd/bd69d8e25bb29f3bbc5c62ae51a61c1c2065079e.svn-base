...
/**
 * Servlet implementation class GetAllMorami
 */
@WebServlet("/GetAllMorami.do")
public class GetAllMorami extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<MoramMemberVO> list = service.getAllMorami(mrNo);		
