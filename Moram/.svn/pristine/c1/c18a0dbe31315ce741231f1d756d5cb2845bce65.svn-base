...
/**
 * Servlet implementation class AdminBoardInfo
 */
@WebServlet("/adminBoardInfo.do")
public class AdminBoardInfo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BoardVO board = service.adminBoardInfo(vo);
