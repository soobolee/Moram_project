...
@WebServlet("/LectureRez.do")
public class LectureRez extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int cnt = service.lectureAgainRezChk(vo);	
		
		if(cnt>0) {
			service.updateLectureRez(vo);
		}else {
			
			String res = service.lectureRez(vo);	
