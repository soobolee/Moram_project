...
/**
 * Servlet implementation class MoramPrefer
 */
@WebServlet("/MoramPrefer.do")
public class MoramPrefer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(vo.getMr_no());
		
		
		IMoramService service = MoramServiceImpl.getInstance();
		
		Object obj = service.moramPrefer(vo);
